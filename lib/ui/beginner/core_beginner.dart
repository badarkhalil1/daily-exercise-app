...
class Core_beginner extends StatefulWidget {
  const Core_beginner({Key? key}) : super(key: key);

  @override
  State<Core_beginner> createState() => _Core_beginnerState();
}

class _Core_beginnerState extends State<Core_beginner> {
