...
class Core_advance extends StatefulWidget {
  const Core_advance({Key? key}) : super(key: key);

  @override
  State<Core_advance> createState() => _Core_advanceState();
}

class _Core_advanceState extends State<Core_advance> {
  ...
  final List<String> imagelist=[
    ...
    'assets/core/Vsit.gif',
    'assets/core/abdominal.gif',
  ];
  @override
