...
class Abs_advance extends StatefulWidget {
  const Abs_advance({Key? key}) : super(key: key);

  @override
  State<Abs_advance> createState() => _Abs_advanceState();
}

class _Abs_advanceState extends State<Abs_advance> {
  ...
  final List<String> imagelist=[
    ...
    'assets/abs/Glute-Bridge-March.gif',
  ];
  @override
